...
def registrar_medicamento():
    ...
    try:
        ...
        messagebox.showinfo("Registro exitoso", "Medicamento guardado correctamente.")
...
def eliminar_medicamento():
    ...
    registro_a_eliminar = f"{valores[0]}|{valores[1]}|{valores[2]}|{valores[3]}\n"

    try:
        with open("medicamento.txt", "r", encoding="utf-8") as archivo:
            registros = archivo.readlines()

        registros_actualizados = [r for r in registros if r != registro_a_eliminar]
