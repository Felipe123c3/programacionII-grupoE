...
def nuevoPaciente():
    ...
    sexoLabel.grid(row=2, column=0, padx=10, pady=5, sticky="w",)
    entrysexo=tk.Entry(ventanaRegistro)
    entrysexo.grid(row=2, column=1, padx=10, pady=5, sticky="we")
    ...
    enfLabel=tk.Label(ventanaRegistro, text="enfermedadesBase:")
